          ...
          <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row gap-16 items-center">
                  <div className="w-full md:w-1/2">
                      ...
                      <h2 className="text-4xl font-bold text-watt-blue mb-6 leading-tight">Rewriting the rules of <br/><span className="text-watt-primary">Business Energy.</span></h2>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="p-5 bg-white shadow-lg rounded-xl border border-gray-100 hover:border-blue-200 transition-colors group">
                              <div className="w-10 h-10 rounded-lg bg-blue-100 text-watt-primary flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                                  <Icons.Search size={20}/>
                              </div>
                              <h3 className="font-bold text-watt-blue mb-1">Transparency</h3>
                          ...
                          <div className="p-5 bg-white shadow-lg rounded-xl border border-gray-100 hover:border-green-200 transition-colors group">
                              ...
                              <h3 className="font-bold text-watt-blue mb-1">Sustainability</h3>
          ...
          <div className="container mx-auto px-4">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-10 md:p-16 relative overflow-hidden">
                  ...
                  <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                      <div className="group">
                          <div className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-watt-dark to-watt-blue mb-3 group-hover:scale-110 transition-transform duration-300 inline-block">£12M+</div>
                      ...
                      <div className="group">
                          <div className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-watt-dark to-watt-blue mb-3 group-hover:scale-110 transition-transform duration-300 inline-block">15k+</div>
                          <div className="h-1 w-12 bg-watt-accent mx-auto mb-3 rounded-full"></div>
                          <div className="text-sm uppercase tracking-widest text-gray-500 font-bold">Happy Customers</div>
                      </div>
                      <div className="group">
                          <div className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-watt-dark to-watt-blue mb-3 group-hover:scale-110 transition-transform duration-300 inline-block">20+</div>
                          <div className="h-1 w-12 bg-watt-accent mx-auto mb-3 rounded-full"></div>
                          <div className="text-sm uppercase tracking-widest text-gray-500 font-bold">Energy Partners</div>
                      </div>
                      <div className="group">
                          <div className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-watt-dark to-watt-blue mb-3 group-hover:scale-110 transition-transform duration-300 inline-block">100%</div>
                          <div className="h-1 w-12 bg-watt-accent mx-auto mb-3 rounded-full"></div>
      ...
      <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
              <div className="relative rounded-[2.5rem] overflow-hidden bg-watt-dark px-6 py-20 text-center shadow-2xl isolate">
                  ...
                  />
                  <div className="absolute inset-0 -z-10 bg-gradient-to-br from-watt-dark via-watt-dark/95 to-blue-900/90"></div>
